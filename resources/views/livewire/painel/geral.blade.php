<div class="row">
    ...
    @if(session()->get("logado") != 'sim') 
        <div class="col-sm-6 text-black">
            ...
            <div class="px-5 ms-xl-4">
                ...
                <span class="h1 fw-bold mb-0" style="display: block; margin-top: 30%;">
    ...
    @else 
        <div style="col-sm-12">
            ...
            <svg wire:click="deslogar" style="cursor:pointer; max-width: 2%; margin: 0 9% 0 auto; display: block;" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 384.971 384.971" style="enable-background:new 0 0 384.971 384.971;" xml:space="preserve"> <g> <g id="Sign_Out"> 	
                    ...
                    <div class="tab-content p-3 text-muted border border-secondary">
                        ...
                        @foreach($movimentos as $movimento)
                            <div class="tab-pane {{ $ativo }}" id="tab{{ $movimento->id }}" role="tabpanel" style="padding: 20px;">
                                ...
                                <pre>
                                    <code>
                                        Endpoint: http://localhost:8080/api/rank_por_movimento/{{ $movimento->id }}
                                    </code>
                                </pre>
